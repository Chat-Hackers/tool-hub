# ChatHackers Tool Hub

This matrix client acts as a wrapper for other chat hackers tools. Send ⚙️ the group chat to wake it up.
...
1. Copy your user id, homeserver and access token from Element into the `.env` file. 
